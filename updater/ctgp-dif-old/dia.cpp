...
int main(int argc, char **argv) {
    ...
    DIA_Diftab_Entry *entries = (DIA_Diftab_Entry*)&dia_data[bswap32(((DIA_Header*)dia_data)->diftab_entry_offset)];
    ...
    for (u32 i = 0; i < entry_count; ++i)
    {
        ...
        memcpy((void*)indata, &dia_data[bswap32(entries[i].offset)], infilesize);
        
        printf("updating file #%u (%s):\n", i + 1, &indata[bswap32(((DIF_Header*)indata)->name_offset)]);
        ...
        strlcat(out_name, (const char*)&indata[bswap32(((DIF_Header*)indata)->name_offset)], 65536);
